...
<div class="nav flex-column admin-tab-menu">
    ...
    <a href="ttable.php">Marks</a>
    <a href="ttasks.php"> Tasks </a>
    ...
    <div class="container-fluid">
        ...
        <div class="col-xxl-12">
                    ...
                    <div class="row row-cols-xl-6 row-cols-md-3 row-cols-2">
                        <div class="col-3">
                            ...
                            <div class="single-resources">
                                ...
                                <h5 class="title"><a href="ttasks.php"> Video Lecture</a></h5>
                            </div>
                            <!-- Single Resources Start -->
                        ...
                        <div class="col-3">
                            ...
                            <div class="single-resources">
                                ...
                                <h5 class="title"><a href="tquiz.php">Quizes</a></h5>
                            </div>
                            <!-- Single Resources Start -->
                        ...
                        <div class="col-3">
                            ...
                            <div class="single-resources">
                                ...
                                <h5 class="title"><a href="texam.php">Exams</a></h5>
                            </div>
                            <!-- Single Resources Start -->
                        ...
                        <div class="col-3">
                            ...
                            <div class="single-resources">
                                ...
                                <h5 class="title"><a href="taddfile.php">Add File</a></h5>
                            </div>
                            <!-- Single Resources Start -->
            ...
            <div class="single-student-widget widget-color-02">
                <h4 class="widget-title"> <a href="#" class="btn btn-primary"> new video</a>
                    <span> --- </span>
                    <a href="#" class="btn btn-primary">List video</a>
                    ...
                    <div class="widget-items ">
                        ...
                        <div class="single-item ">
                            ...
                            <div class="item ">
                                <div class=" "> <span> <input type="file"  class="input-group-text"></span></div>
                            </div>
                        </div>
                        <!-- Single Item End -->
                        ...
                        <div class="single-item ">
                            <div class="title ">
                                <a href="course.php ">Title </a>
                            </div>

                            <div class="item ">
                                <div class=" "> <span> <input type="text" class="input-group-text"></span></div>
                            </div>
                        </div>
                        <div class="single-item ">
                            <div class="title ">
                                <a href="course.php ">Unit / Chapter :</a>
                            </div>
                        ...
                        <div class="single-item ">
                            <div class="title ">
                                <a href="course.php ">Description</a>
                            </div>

                            <div class="item ">
                                <div class=" "> <span> <textarea name="message" class="form-control" placeholder="Message"></textarea></span></div>
                            </div>
                        </div>
                        <div class="single-item ">
                            <div class="title ">
